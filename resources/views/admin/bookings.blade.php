        ...
        <div class="container mx-auto px-6 max-w-7xl">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div class="lg:col-span-3">
                    <div
                        class="flex bg-white rounded-lg p-1 border border-gray-200 mb-6 text-xs font-medium text-center shadow-sm">
                        <a href="{{ request()->fullUrlWithQuery(['range' => 7]) }}"
                            class="flex-1 rounded-md py-2 transition {{ (!isset($range) || $range == 7) ? 'bg-gray-100 text-gray-700' : 'text-gray-500 hover:bg-gray-50' }}">7
                            วันที่ผ่านมา</a>
                        <a href="{{ request()->fullUrlWithQuery(['range' => 30]) }}"
                            class="flex-1 rounded-md py-2 transition {{ (isset($range) && $range == 30) ? 'bg-gray-100 text-gray-700' : 'text-gray-500 hover:bg-gray-50' }}">30
                            วันที่ผ่านมา</a>
                    </div>
