...
<head>
    ...
    <style>
        ...
        .code-box .code { display: inline-block; font-family: 'Courier New', monospace; font-size: 28px; font-weight: 800; letter-spacing: 2px; color: #0b0b1a; background: #f9fafb; border: 2px dashed #f59e0b; border-radius: 10px; padding: 12px 22px; }
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <p class="sub">แจ้งเตือนเครดิต</p>
        </div>

        <div class="status-bar">
            <span class="dot"></span><span class="label">เครดิตของคุณใกล้หมดอายุ</span>
        </div>

        <div class="code-box">
            <div class="label">เครดิตคงเหลือ</div>
            <div class="code">{{ number_format($user->credit_balance / 100, 2) }} ฿</div>
        </div>

        <div class="body">
            <p class="greet">สวัสดีคุณ {{ $user->us_name }}</p>

            <table class="detail-table">
                <tr>
                    <td class="k">เครดิตคงเหลือ</td>
                    <td class="v">{{ number_format($user->credit_balance / 100, 2) }} บาท</td>
                </tr>
                <tr class="expire">
                    <td class="k">วันหมดอายุ</td>
                    <td class="v">{{ $user->credit_expires_at->format('d/m/Y') }}</td>
                </tr>
            </table>

            <div class="checkin-box">
                <p><strong>กรุณาใช้เครดิตของคุณก่อนวันหมดอายุ</strong> เครดิตที่หมดอายุแล้วจะไม่สามารถใช้งานหรือกู้คืนได้</p>
            </div>
