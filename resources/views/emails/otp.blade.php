...
<head>
    ...
    <title>รหัส OTP สำหรับสมัครสมาชิก</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="body">
            <p>สวัสดีครับ/ค่ะ</p>
            <p>เราได้รับคำขอรหัส OTP สำหรับสมัครสมาชิกของคุณ กรุณาใช้รหัส OTP ด้านล่างเพื่อดำเนินการต่อ:</p>

            <div class="otp-box">
                <div class="label">รหัส OTP ของคุณ</div>
                <div class="code">{{ $otp }}</div>
            </div>

            <div class="warning">
                <p>⚠️ รหัสนี้จะหมดอายุใน <strong>5 นาที</strong> — หากคุณไม่ได้สมัครสมาชิก กรุณาเพิกเฉยต่ออีเมลฉบับนี้</p>
            </div>
